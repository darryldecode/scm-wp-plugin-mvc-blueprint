var SCM_COMMON_SERVICE_MODULE = angular.module('SCM_COMMON_SERVICE_MODULE', []);

SCM_COMMON_SERVICE_MODULE.service('GlobalLoaderService',[function () {
    ...
    this.effect = function (loaderText, loaderMode, icon) {
        return '<div id="globalEffect" class="alert alert-'+loaderMode+' text-center animated fadeInDown" style="font-size: 15px; padding: 10px; width: 260px; height: auto; position: fixed; z-index: 999; bottom: 0; right: 0; margin-right: 10px; margin-bottom: 10px;">' +
